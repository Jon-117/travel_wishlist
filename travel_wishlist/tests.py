...
class TestHomePage(TestCase):
    def test_home_page_shows_empty_list_message_for_empty_database(self):
        ...
        self.assertContains(response, 'No places in your wishlist')
...
class TestVisitedPage(TestCase):
    def test_visited_page_shows_message_for_empty_list(self):
        ...
        self.assertContains(response, 'You need to travel more...')


class TestVisitedPageHasRightPlaces(TestCase):
    fixtures = ['test_places']

    def test_visited_page_shows_correct_places(self):
        response = self.client.get(reverse('visited'))
        self.assertTemplateUsed(response, 'travel_wishlist/visited.html')
...
class TestVisitPlace(TestCase):
    ...
    def test_non_existent_place(self):
        visit_nonexistent_place_url = reverse('place_was_visited', args=(123456789,))
